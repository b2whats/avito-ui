...
describe('numberFormatter', function () {
  describe('default integer format', function () {
    var pipe = pipeFormatter(_numberFormatter.numberFormatter);
  ...
  describe('positiveOnly', function () {
    var pipe = pipeFormatter(_numberFormatter.numberFormatter.setup({
      positiveOnly: false
    }));
    it('removes sign by default', function () {
      return expect(pipeFormatter(_numberFormatter.numberFormatter)('-123')).toBe('123');
    });
