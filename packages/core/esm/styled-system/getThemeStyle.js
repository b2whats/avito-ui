...
export var foldScheme = function foldScheme(scheme, props, only) {
  var result = {
    style: {},
    props: {},
    component: null
...
export var getStyles = function getStyles(params, tokens) {
...
export function foldThemeParams(props, _ref) {
...
export function createClassName(createRule, createUserRule) {
