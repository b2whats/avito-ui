...
declare type MouseHandler = (event: React.MouseEvent<SVGSVGElement | HTMLButtonElement>) => void;
declare type StyleProps = AlignProperties & SpaceProperties & ColorProperties & DimensionProperties & BorderProperties & LayoutProperties & VisibilityProperties;
