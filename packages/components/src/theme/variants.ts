...
export type VariantsTheme = {
  ...
  input_color_normal: string,
  input_color_hover: string,
  input_color_active: string,
  input_color_disabled: string,

  input_backgroundColor_normal: string,
  input_backgroundColor_hover: string,
  input_backgroundColor_active: string,
  input_backgroundColor_disabled: string,

  input_borderColor_normal: string,
  input_borderColor_hover: string,
  input_borderColor_active: string,
  input_borderColor_disabled: string,
}
...
export const variantsTheme: ComputedTheme<VariantsTheme> = ({ variants, palette }, override) => {
  const defaultTheme = {
    ...
    primary_color_active: palette[`${variants.primary}80`],
    ...
    success_color_active: palette[`${variants.success}80`],
    ...
    warning_color_active: palette[`${variants.warning}80`],
    ...
    error_color_normal: palette[`${variants.error}40`],
    error_color_hover: palette[`${variants.error}60`],
    error_color_active: palette[`${variants.error}70`],
    ...
    input_color_normal: palette.gray90,
    input_color_hover: palette.gray90,
    input_color_active: palette.gray90,
    input_color_disabled: palette.gray30,

    input_backgroundColor_normal: palette.white,
    input_backgroundColor_hover: palette.gray10,
    input_backgroundColor_active: palette.gray20,
    input_backgroundColor_disabled: palette.gray20,

    input_borderColor_normal: palette.gray40,
    input_borderColor_hover: palette.gray50,
    input_borderColor_active: palette.gray60,
    input_borderColor_disabled: palette.gray20,
  } as VariantsTheme
