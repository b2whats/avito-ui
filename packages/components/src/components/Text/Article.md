...
<Article>
  <Text kind='h1'>How Tax-Efficient Is This Fund?</Text>
  <Text kind='p'><Text bold>Question: </Text>
    I am looking for funds for a taxable account. How can I tell if a fund is tax-efficient?
  </Text>
  <Text kind='p'><Text bold>Answer: </Text>
  ...
  <Text kind='h4'>Tax-Efficient by Nature"</Text>
  <Text kind='p'>
